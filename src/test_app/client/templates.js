(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">NetFlow Viewer</a></div><ul class="nav navbar-nav"><li><a href="/">Home</a></li><li class="dropdown"><a href="/list" data-toggle="dropdown" class="dropdown-toggle">List View</a><ul role="menu" class="dropdown-menu"><li><a href="/list">List1</a></li><li><a href="/list">List2</a></li></ul></li></ul></div></nav><div class="container"><main data-hook="page-container"></main></div></body>';
    };

    // pages/home.jade compiled template
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<section class="page"><h3>Home</h3></section>';
    };

    // pages/list.jade compiled template
    templatizer["pages"]["list"] = function tmpl_pages_list() {
        return '<section class="page"><h3>List</h3></section>';
    };
